...
public class Exercise_13_Harvester extends Robot
{
    ...
    {
        // Error here: When trying to harvest all the Things at
        // one intersection, it would just pickThing() once. Fixed by placing it in a
        // loop,
        // so it would keep picking until there is no more Things to be picked.
